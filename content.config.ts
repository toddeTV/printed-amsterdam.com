...
export default defineContentConfig({
  collections: {
    ...
    stages: defineCollection({
      ...
      source: 'stages/**/*.yml',
      schema: z.object({
        slug: z.string().describe('The UNIQUE slug of the stage. This is used to identify and link the stage to other collections. Never change this!'),
    ...
    speakers: defineCollection({
      ...
      source: 'speakers/**/*.md',
      schema: z.object({
        slug: z.string().describe('The UNIQUE slug of the speaker. This is used to identify and link the speaker to other collections. Use `firstname-lastname` as convention. Never change this!'),
        ...
        socialMedia: z.array(z.object({
          ...
          icon: z.string().optional().editor({ input: 'icon' }).describe('Optionally override the icon. Per default it is detected automatically. Please only use `Simple Icons`'),
        })).default([]),
      }),
    }),
    ...
    talks: defineCollection({
      ...
      source: 'talks/**/*.md',
      schema: z.object({
        slug: z.string().describe('The UNIQUE slug of the talk. This is used to identify and link the stage to other collections. Never change this!'),
